...
let Comp = {
    name: "Putete", // Nombre de la computadora
    set: 4, // Bits del Set de Instrucciones
    kb: 8, // Bits de la Capacidad de direccionamiento
...
function evalExec(inst, op) {
    ...
    switch (inst) {
        ...
        case "JUI":
            ...
            break;
        case "WRT":
            this.postMessage({ Disp: "Putete! " + Comp.reg.acum });
            console.log("DISPLAY: " + Comp.reg.acum);
            break;
        case "PTT":
            this.postMessage({ Disp: "Putete!" });
